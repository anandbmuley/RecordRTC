...
// Last time updated: 2024-03-25 7:48:33 AM UTC
...
function MediaStreamRecorder(mediaStream, config, db) {
    ...
    this.record = function() {
        ...
        mediaRecorder.ondataavailable = function(e) {
            console.log("[ABM] ondataavailable", e.data.size, e.data.type);
            if (e.data) {
    ...
    this.stop = function(callback) {
        ...
        if (typeof config.timeSlice === "number") {
            console.info("[ABM] Timeslicing function...");
            setTimeout(function() {
                console.info(
                    "[ABM] Running the timeslicing loop...",
                    mediaRecorder.state
                );
